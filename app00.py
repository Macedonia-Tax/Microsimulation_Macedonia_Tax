...
etr17c = np.divide(citax17c_with_MAT,AggInc17c)
etr17c[~np.isfinite(etr17c)] = 0
wtd_etr17c = sum(etr17c*wgt17c.values/sum(wgt17c.values))
...
print('\n\n\n')
print(f'GTI before loss, 2017, cross-section: {sum(AggInc17c * wgt17c) / 10**9:,.0f} Billion')
print(f'Deductions, 2017, cross-section: {sum(GTI17c * wgt17c) / 10**9:,.0f} Billion')
print(f'Total liability, 2017, cross-section: {sum(citax17c * wgt17c) / 10**9:,.0f} Billion')
print(f'Total liability with MAT, 2017, cross-section: {sum(citax17c_with_MAT * wgt17c) / 10**9:,.0f} Billion')
print(f'Effective Tax Rate, 2017, cross-section: {wtd_etr17c*100:,.1f}%')
