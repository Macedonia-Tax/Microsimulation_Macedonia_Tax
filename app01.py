...
calc1c = Calculator(policy=pol1, records=recs, corprecords=crecs1, gstrecords=grecs)
calc1p = Calculator(policy=pol1, records=recs, corprecords=crecs2, gstrecords=grecs)
calc2c = Calculator(policy=pol2, records=recs, corprecords=crecs1, gstrecords=grecs)
calc2p = Calculator(policy=pol2, records=recs, corprecords=crecs2, gstrecords=grecs)
...
print('\n')
print('GTI before loss, reform, cross: ' + str(sum(AggIncCR * wgtCR) / 10**7))
...
print('\n')
print('Change in tax, cross: ' + str(sum((citaxCR - citaxCB) * wgtCB) / 10**7))
print('\n')
...
print('\n')
print('GTI before loss, reform, panel: ' + str(sum(AggIncPR * wgtPR) / 10**7))
